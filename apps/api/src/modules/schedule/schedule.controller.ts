...
export const patchPeriod = wrapMutateById(svc.getPeriodSchoolId, req => svc.updatePeriod(req.params.id, req.body));
...
export const patchDay = wrapMutateById(svc.getDaySchoolId, req => svc.updateDay(req.params.id, req.body));
...
// Conflicts
export const getConflicts = wrap(req => svc.listConflicts(req.schoolId || '', req.query.includeResolved === 'true'));
...
export const patchEvent = wrapMutateById(svc.getEventSchoolId, req => svc.updateEvent(req.params.id, req.body));
...
export const patchTemplate = wrapMutateById(svc.getTemplateSchoolId, req => svc.updateTemplate(req.params.id, req.body));
...
export const patchExamSlot = wrapMutateById(svc.getExamSlotSchoolId, req => svc.updateExamSlot(req.params.id, req.body));
